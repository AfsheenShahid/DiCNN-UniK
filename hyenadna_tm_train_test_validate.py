...
if not os.path.exists('/content/gdrive/MyDrive'):
    ...
    print(f"📊 Model Parameter Count (Trainable): {n_params:,}")
    ...
    for file in ext_files:
        ...
        print(f"⏱️ Total inference time: {total_time:.4f} seconds")
        print(f"⏱️ Inference time per sample: {inference_time_per_sample*1000:.4f} ms")
        ...
        try:
            ...
            plt.close()
            print(f"📈 Saved ROC curve to {os.path.join(output_dir, f'{dataset_name}_roc_curve.pdf')}")
